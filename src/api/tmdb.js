...
export const fetchMovieCollection = (id) => request('/movie/collection', { id });

export const fetchPersonDetails = (id) => request('/person/details', { id });

export const fetchPersonMovieCredits = (id) => request('/person/movie-credits', { id });
